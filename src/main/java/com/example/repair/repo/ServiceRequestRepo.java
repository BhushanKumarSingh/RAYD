...
public interface ServiceRequestRepo extends CrudRepository<ServiceRequest, Integer>{
	...
	/*
	 * This query for get all service request details for a particular service provider
	*/
	...
	*/
	...
	/*
	 * This query is for count number of request type means how many electronics, mechanics and so on
	*/
	...
	/*
	 * This query is for count number of request type means how many electronics, mechanics and so on for a particular user 
	*/
	...
	/*
	 * This query is to get invoice details for a particular service request, retrieving details using inner join
	*/
	...
	/*
	 * This query for find the service request details which has service status is completed but payment is not completed
	*/
	...
	*/
	...
	/*
	 * This query is for update the assign technician in service request table for a particular request
	*/
	@Modifying
